    ...
    <div>
      <div className=" my-4 h-[70vh]  w-full rounded-xl flex overflow-hidden">
        ...
        <div className="h-full  w-2/3 rounded-xl flex flex-col">
          ...
          <div className="bg-[url('/pic/toi1.jpg')] hidden"></div>
          <div className="bg-[url('/pic/toi2.jpg')] hidden"></div>
          <div className="bg-[url('/pic/toi3.jpg')] hidden"></div>
          <div className="bg-[url('/pic/toi0.jpg')] hidden"></div>
